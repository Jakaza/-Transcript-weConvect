...
$fail = 0;
if(isset($_POST['lecturersignup'])){
    $uid = $_POST['lecturer_number'];
    ...
    $password = md5($upass);
    if($res = mysqli_query($conn,"SELECT * FROM lecturer WHERE lecturer_number = '$uid'")){
        if(mysqli_num_rows($res) > 0){
            $fail = 1;
        } 
        else if(mysqli_query($conn,"INSERT INTO lecturer(lecturer_number,name,surname,rsa_id,email,password) VALUES('$uid','$uname','$surname','$rsa_id','$email','$password')") && mysqli_query($conn,"CREATE TABLE `$uid`(id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,userid VARCHAR(50),sub VARCHAR(50),test VARCHAR(50),score VARCHAR(50))")){
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="oq-signup text-center">
                        ...
                        <form class="form" action="" method="post" name="create">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Lecturer Number"
                                name="lecturer_number" autofocus required><br>
