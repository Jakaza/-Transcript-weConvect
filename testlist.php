<?php
    ...
    $result=mysqli_query($conn,"SELECT * FROM student WHERE student_number = '$userid'");
...
<head>
    ...
    <?php
                    ...
                    ?>
    <?php
                        // =mysqli_query($conn,"SELECT * FROM subject JOIN assessment ON subject.subj_code = assessment.subj_code WHERE subject.subj_code = '$subject'")
                        //= mysqli_query($conn,"SELECT * FROM `$subject`"
                        $result1 = mysqli_query($conn,"SELECT * FROM subject JOIN assessment ON subject.subj_code = assessment.subj_code WHERE subject.subj_name = '$subject'");
                        echo "<script>var words = [],k = 0;</script>";
                        if(mysqli_num_rows($result1) > 0){
                            while ($row1 = mysqli_fetch_assoc($result1)) {
                                echo "<script>words[k] = ".json_encode($row1['assessment_name']).";
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="oq-userArea pull-right">
                        <span class="oq-username"><?php echo $row['student_number'];?> </span>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="oq-menu">
                        ...
                        document.write(
                            '<span id="oq-subjectsList">List of tests for the subject <?php echo $subject?> are..<br><br>'
                        );
                        for (i = 0; i < k; i++) {
