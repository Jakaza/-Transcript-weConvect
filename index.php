<?php
    ...
    if(isset($_POST['login'])){
        ...
        $password = md5($upass);
        $result=mysqli_query($conn,"SELECT * FROM student WHERE student_number = '$uid' AND password = '$password'");
            ...
            <div class="row">
                ...
                <div class="col-md-2 pull-right">
                    <div class="oq-adminArea">
                        <a class="oq-admin" href="admin.php">Lecturer Login</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="oq-bodyContent">
                        ...
                        <p>This Site will provide the quiz for various subject of interest. You need to login for online
                            quiz.</p>
                    </div>
                </div>
