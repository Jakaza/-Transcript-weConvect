<?php
    ...
    //mysqli_query($conn,"SELECT answer FROM `question` WHERE assessment_id = `$test`")
	if($result = mysqli_query($conn,"SELECT question.answer FROM assessment JOIN question ON assessment.assessment_id = question.assessment_id WHERE assessment.assessment_name = '$test'")){
