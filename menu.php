...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="oq-menu">
                        <span id="oq-subjectsList"><span class="oq-menuHead">Welcome to online quiz
                                <?php echo $row['name'];?>...</span><br><br>To know about all the subjects, say List
                            the subjects .</span>
    ...
    function subjects() {
        ...
        recognition.onresult = function(event) {
            ...
            if (speechResult == 'list the subjects' || speechResult == 'list the subject' || speechResult ==
                'subject' || speechResult == 'subjects') {
                flag = 1;
