...
if(isset($_POST['login'])){
    ...
    $result = mysqli_query($conn,"SELECT * FROM lecturer WHERE lecturer_number = '$aid' AND password = '$password'");
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="oq-adminlogin text-center">
                        ...
                        <span class="oq-signupHead">Lecturer login</span><br><br>
                        <?php if($fail == 1){
                                    echo "<span class='oq-error'>*Invalid details</span><br><br>";
                                    }
                            ?>
                        <form class="form" action="" method="post">
                            <input type="text" class="form-control" placeholder="Enter Lecturer Number" name="adminid"
                                required autofocus><br>
                            <input type="password" class="form-control" placeholder="Enter Password" name="adminpass"
                                required><br>
                            <input type="submit" class="form-control btn btn-primary" value="Login" name="login"><br>
                            <br><br>
                            New user? <a href="signuplecturer.php" class="">Signup for New Account</a><br><br>
                        </form>
                    </div>
                </div>
            </div>
