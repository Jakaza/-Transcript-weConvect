            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="oq-userArea pull-right">
                        <a href="viewtests.php?code=<?php echo "$subj_code";?>"><span
                                    ...
                                    <div class="modal-body">
                                        <div class="oq-questionModal">
                                            <form class="form" action="createquestions.php" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-inline"><input type="radio" name="answer"
                                                                value="A" required> &nbsp;A) &nbsp;<textarea
                                                                class="form-control" placeholder="Enter option A"
                                                                name="option1" required></textarea></div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-inline"><input type="radio" name="answer"
                                                                value="B" required> &nbsp;B) &nbsp;<textarea
                                                                class="form-control" placeholder="Enter option B"
                                                                name="option2" required></textarea></div>
                                                    </div>
                                                </div><br>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-inline"><input type="radio" name="answer"
                                                                value="C" required> &nbsp;C) &nbsp;<textarea
                                                                class="form-control" placeholder="Enter option C"
                                                                name="option3" required></textarea></div>
                                                    </div>
                        ...
                        <table class="table oq-table">
                            <tbody>
                                <?php
                                                        ...
                                                        $res=mysqli_query($conn,"SELECT * FROM assessment JOIN question ON assessment.assessment_id = question.assessment_id WHERE assessment.assessment_id = '$test'");
                                                        if($res){
                                                            ...
                                                            while($row1 = mysqli_fetch_assoc($res)) {
                                                                ...
                                                                echo "<tr><td>Question ".$i."</td><td>".nl2br(ucfirst($row1['question_text']))."<br><br><div class='row'><div class='col-md-6'>A) ".nl2br(ucfirst($row1['option1']))."</div><div class='col-md-6'>B)  ".nl2br(ucfirst($row1['option2']))."</div></div><br><div class='row'><div class='col-md-6'>C) ".nl2br(ucfirst($row1['option3']))."<div class='row'><div class='col-md-6 col-md-offset-3'>Answer : ".nl2br(ucfirst($row1['answer']))."</div></div><br>
                                                                <div class='row'><div class='col-md-10 col-md-offset-1'><span class='oq-news'>Explaination:</span><br><br>"."</div></div></td><td class='oq-operations'><a data-toggle='modal' data-target='.".$row1['question_id']."' class='oq-btn'><span class='glyphicon glyphicon-pencil'></span> Edit Question</a> <br><br><a data-toggle='modal' data-target='.del".$row1['question_id']."' class='oq-deletebtn'><span class='glyphicon glyphicon-remove'></span> Delete</a></td></tr>";
                                                                $i++;
                                                                
                                                                
                                                                
                                                                echo "<div class='modal fade ".$row1['question_id']."' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel'>
                                                                  <div class='modal-dialog' role='document'>
                                                                    <div class='modal-content'>
                                                                        <div class='modal-body'>
                                                                            <div class='oq-questionModal'>
                                                                                <form class='form' action='upquestions.php' method='post'>
                                                                                    ...
                                                                                    <span>Question</span><br><br>
                                                                                    <input type='hidden' class='form-control' value='".$row1['question_id']."' name='qid'>
                                                                                    <textarea class='form-control' name='title'>".$row1['question_text']."</textarea><br>
                                                                                    <div class='row'>
                                                                                        <div class='col-md-6'>
                                                                ...
                                                                echo "<div class='modal fade del".$row1['question_id']."' tabindex='-1' role='dialog' aria-labelledby='mySmallModalLabel'>
                                                                        ...
                                                                        <div class='modal-body'>
                                                                            <div class='oq-questionModal'>
                                                                                ...
                                                                                <form class='form' action='quesdel.php' method='post'>
                                                                                    <input type='hidden' name='delval' value='".$row1['question_id']."'>
